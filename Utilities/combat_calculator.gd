...
func calculate_damage_done(weapon: WeaponStats, attacker: CharacterStats, defender: CharacterStats, handed: String) -> int:
	...
	return weapon_damage - defender.defense * e_constant
